...
function updateProgress(slideNumber) {
    var slide_number = document.querySelector('.pagination .slide_number');
    var progress = document.querySelector('div.progress .bar');
    var slides_count = document.querySelectorAll('section').length;
    if (null === progress) { return; }
    progress.style.width = ((100 / slides_count) * slideNumber).toFixed(2) + '%';
    slide_number.innerHTML = slideNumber+"/"+slides_count;
}
