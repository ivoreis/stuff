$(function() {
    ...
    $('.modal-body input.date').each(function(){
        var $this = $(this);
        var opts = { 'dateFormat': 'm/d/yy', 'inline': true, 'showOtherMonths': true};
    ...
    $('.modal-body input.time').each(function() {
        var $this = $(this);
        var opts = { 'showDuration': true, 'timeFormat': 'G:i', 'scrollDefaultNow': true };
